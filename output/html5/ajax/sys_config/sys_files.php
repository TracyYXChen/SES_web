...
$dir = "/var/www/html/ses/results/users/";
...
//       error_log( print_r( $results, true ) . "\n", 3, "/tmp/mylog" );
       ...
       if ( isset( $do_cmd ) )
       {
          ...
          $deldir = "/var/www/html/ses/deleted/users/" . $GLOBALS[ 'logon' ] . "/" . $uniq;
          $tries = 0;
          while ( file_exists( $deldir ) )
          {
              $deldir = "/var/www/html/ses/deleted/users/" . $GLOBALS[ 'logon' ] . "/" . bin2hex( openssl_random_pseudo_bytes ( 6, $cstrong ) );
              if ( ++$tries > 100 )
              {
