...
// $subject =  gethostname() . "/ses " . $_REQUEST[ 'level' ] . " feedback from " . $results[ '_logon' ] . "@" . $GLOBALS[ 'REMOTE_ADDR' ] . ( isset( $results[ '_project' ] ) ? " project " . $results[ '_project' ] : "" );

$subject =  "[" . gethostname() . "/ses-feedback][" . $_REQUEST[ 'level' ] . "] '" . $_REQUEST[ 'subject' ] . "' " . $_REQUEST[ 'email' ];
