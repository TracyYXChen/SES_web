...
if ( $_REQUEST[ '_logon' ] != $_SESSION[ $window ][ 'logon' ] )
{
   ...
   mymail( $json->mail->admin, 'security alert ses', "session timeout or possible security breach attempt on ses\n" .
                   ...
                   if ( $keok && $kedoc ) {
                       ...
                       switch ( $k ) {
                           case "color:body:color" :
                               $results[ $k ] = rgbtohex( "0,0,0" );
                           break;
                           case "color:body:background" :
                               $results[ $k ] = rgbtohex( "255,255,255" );
                           break;
                           default :
                               $results[ $k ] = "";
                           break;
