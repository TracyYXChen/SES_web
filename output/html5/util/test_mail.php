...
echo "from /opt/genapp/ses/appconfig.json:\n";
print_r( $json->mail );
...
if ( mymail( $argv[ 1 ], "[$host][ses][test message][$smtp]", "This is a ses test message from host named $host send by $argv[0] using $smtp" ) )
{
