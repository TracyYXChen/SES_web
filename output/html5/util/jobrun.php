                ...
                if ( $doc = $coll->findOne( [ "name" => $GLOBALS[ 'logon' ] ] ) ) {
                    if ( $doc[ 'email' ] ) {
                        ...
                        if ( $type == "finished" ) {
                            $body .= 
                                "Access your results:\n"
                                . "http://" . $app->hostname . "/ses/?_reqlogin=1&_switch=" . $GLOBALS[ 'getmenumodule' ] . "/" . $GLOBALS[ 'getmenumoduleproject' ] . "/" . $_REQUEST[ '_uuid' ]
                                ;
                        }
                        mymail( $doc[ 'email' ], "[ses][" . $GLOBALS[ 'menu' ] . ":" . $GLOBALS[ 'module' ] . "][$type]", $body );
                    }
                }
            }
            break;
