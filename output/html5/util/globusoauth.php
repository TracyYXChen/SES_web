...
$redirect_uri = ( isset( $app->oauth2->use_https ) ? "https" : "http" ) . "://" . $app->hostname . "/ses/util/globusoauth.php";  
...
if (isset( $app->oauth2->only) )
  {
     	...
     	if ( $user_username_split[1] == $val)
	{
     ...
     if (!$source)
     {
         $redirect_uri = ( isset( $app->oauth2->use_https ) ? "https" : "http" ) . "://" . $app->hostname . "/ses/". "/?sourcefailed=1";
...
{  
   $redirect_uri = ( isset( $app->oauth2->use_https ) ? "https" : "http" ) . "://"  . $app->hostname . "/ses/". "/?register=1&weloggedinglobus=1&email=$user_email&name=$user_name&username=$user_username&username_split=$user_username_edited";
}
else
{
   $redirect_uri = ( isset( $app->oauth2->use_https ) ? "https" : "http" ) . "://" . $app->hostname . "/ses/". "/?weloggedinglobus=1&email=$user_email&name=$user_name&username=$user_username&username_split=$user_username_edited";
}	
